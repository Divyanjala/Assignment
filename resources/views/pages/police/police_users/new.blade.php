        ...
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card border shadow ">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('police.public-users.create') }}">
                        @csrf

                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputDivision">Full Name</label>
                                <input type="text" class="form-control" id="inputDivision" name="name" required>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="inputCity" name="nic" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputLandphone">Mobile</label>
                                <input type="number" class="form-control" id="inputLandphone" name="mobile" required>
                            </div>
                        </div>
