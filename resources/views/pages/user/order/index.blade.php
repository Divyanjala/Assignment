        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="col-lg-4 text-right">
                    ...
                    <a href="{{ route('user.order.new') }}" class=" btn btn-sm btn-primary float-right">
                                ...
                                <div class="dropdown no-arrow mb-1">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                        ...
                                        <a class="dropdown-item edit-product"
                                            href="{{ route('user.order.view', ['id' => $order->id]) }}"
                                        ...
                                        <a class="dropdown-item edit-order"
                                            href="{{ route('user.order.add-store', ['id' => $order->id]) }}"
                                            class="btn btn-warning" title="">
                                        ...
                                        <a class="dropdown-item approve-order" href="{{ route('user.payment.new', ['id' => $order->id]) }}"
