        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="col-lg-4 text-right">
                    ...
                    {{-- <a href="{{ route('user.product-store.new') }}" class=" btn btn-sm btn-primary float-right">
                                ...
                                <div class="dropdown no-arrow mb-1">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left shadow animated--fade-in"
                                        ...
                                        <a class="dropdown-item delete-customer" class="btn btn-danger" title=""
                                            href="{{ route('user.order.view', $store->order_id) }}">
                                        ...
                                        <hr>
                                            <a class="dropdown-item delete-customer"
                                                ...
                                                href="{{ route('user.task.new', $store->id) }}">
