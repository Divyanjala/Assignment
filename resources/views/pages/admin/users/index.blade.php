    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div class="col-lg-6 col-7">
                <h6 class="h4 text-dark d-inline-block mb-0">User Management</h6>

            </div>
            <div class="col-lg-4 text-right">

                <a href="{{ route('admin.user.new') }}" class=" btn btn-sm btn-primary float-right">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @case(1)
                               ...
                               @break
                            @case(2)
                               <span class="badge badge-pill badge-primary">SUPERVISOR</span>
                               @break
