...
class TicketController extends Controller
{
    ...
    public function new()
    {
        ...
        return view('pages.user.tickets.new')->with($res);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($res) {
            ...
            return redirect(route('user.ticket.new'))->with('alert-success', $msg);
        } else {
            return redirect(route('user.ticket.new'))->with('alert-danger', 'Something Went Wrong, Please Try Again Later');
        }
    }
